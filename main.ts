sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(murderer_of_pumpkin, effects.fire, 200)
    music.play(music.createSoundEffect(WaveShape.Square, 5000, 508, 255, 117, 500, SoundExpressionEffect.None, InterpolationCurve.Linear), music.PlaybackMode.InBackground)
    info.changeScoreBy(1)
    murderer_of_pumpkin = sprites.create(img`
        . f f f . f f f f . f f f . 
        f f f f f 7 7 7 7 f f f f f 
        f f f f 7 7 3 7 3 7 f f f f 
        f f f 7 3 7 7 7 7 3 7 f f f 
        . f 3 3 7 7 7 7 7 7 3 3 f . 
        . f 7 7 7 7 4 4 7 3 7 7 f . 
        . f f 7 7 4 4 4 4 7 7 f f . 
        . f f f 8 f 4 4 f 8 f f f . 
        ...
        . . . . 5 5 . . 5 5 . . . . 
        `, SpriteKind.Enemy)
    murderer_of_pumpkin.setPosition(randint(10, 150), randint(10, 110))
    info.startCountdown(6)
})
let murderer_of_pumpkin: Sprite = null
scene.setBackgroundImage(img`
    ...
    `)
let MM2LOVE = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . d . . . . . . . . 
    . . . . . . . d . 2 2 . . . . . 
    . . . . . . f f f . 2 . . . . . 
    . . . 2 2 4 4 4 4 4 2 . . . . . 
    . . 2 2 4 4 4 4 4 4 2 4 . . . . 
    . . 2 2 4 4 4 4 4 4 2 2 4 . . . 
    . . 4 4 f f f 4 f f 2 2 2 . . . 
    . . 2 4 4 f f 4 f f 4 2 2 . . . 
    . 2 4 4 4 4 4 4 4 4 4 2 4 . . . 
    . 2 4 4 f f f f f f f 2 2 . . . 
    . 2 4 4 f 7 7 7 7 7 f 4 2 . . . 
    . 2 4 4 f f f f f f f 4 2 2 . . 
    2 2 d 2 d d 2 d 2 d d d d 2 . . 
    2 . d d d d d d d 2 d 2 d . . . 
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(MM2LOVE)
MM2LOVE.setStayInScreen(true)
murderer_of_pumpkin = sprites.create(img`
    . f f f . f f f f . f f f . 
    f f f f f 7 7 7 7 f f f f f 
    f f f f 7 7 3 7 3 7 f f f f 
